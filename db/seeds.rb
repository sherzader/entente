...
Event.create([
  { title: "Mushroom Foraging", body: "Hike and spot the various mushroom species!", location: "Muir Woods", date: DateTime.new(2016,2,21,9,0), group_id: groups[1].id, organizer_id: users.first.id, img_url: "21508192309_c2304bff19_z_tuddmy.jpg"},
  { title: "Sunset Walk", body: "Take in the crisp, salty air on this 5 mile walk.", location: "Bolinas", date: DateTime.new(2016,2,22,17,0), group_id: groups[1].id, organizer_id: users.first.id, img_url: "21473947675_dcaca3b781_z_s0rxkv.jpg"},
  { title: "Pots for Planting", body: "Throw clay for the perfect pot", location: "Ceramic Studio on Castro", date: DateTime.new(2016,2,21,12,0), group_id: groups[2].id, organizer_id: users.last.id, img_url: "tumblr_men7huHU7j1r6furjo1_1280_cts1qn.jpg"},
  { title: "Mad Hatter", body: "Making the wildest of hats to wear on our Un-Birthdays!", location: "Wilfred's House", date: DateTime.new(2016,2,18,14,0), group_id: groups[2].id, organizer_id: users.last.id, img_url: "167764_ba17eee87c_z_kirooi.jpg"},
  { title: "Painting", body: "Paint it up - drip style like Pollack or finger style like when you were 5", location: "Downtown Studio", date: DateTime.new(2016,2,19,16,0), group_id: groups[3].id, organizer_id: users[4].id, img_url: "tumblr_o0b82hxi2v1qa6y0bo1_540_cmgn7y.jpg"},
  { title: "Late Afternoon Photography", body: "Taking it way outdoors to capture nature's essence", location: "Pacifica", date: DateTime.new(2016,2,20,16,0), group_id: groups[3].id, organizer_id: users[4].id, img_url: "21493898355_067b2e4d90_z_msv7gz.jpg"},
  { title: "SF Chronicle's Crossword", body: "Can't wait to open up that the morning paper with y'all.", location: "Philz", date: DateTime.new(2016,2,23,9,0), group_id: groups[4].id, organizer_id: users[11].id, img_url: "tumblr_lfdifaZuX31qd32e5o1_540_oceczw.jpg"},  { title: "P", body: "If it's too windy, smack your coffee mug ontop of that loose corner.", location: "The Sidewalk Cafe", date: DateTime.new(2016,1,14,9,0), group_id: groups[3].id, organizer_id: users[11].id, img_url: "tumblr_lfdifaZuX31qd32e5o1_540_oceczw.jpg"},
  { title: "Oakland Tribune's X-Word", body: "If it's too windy, slap your coffee mug on that loose corner.", location: "The Sidewalk Cafe", date: DateTime.new(2016,2,22,9,0), group_id: groups[4].id, organizer_id: users[11].id, img_url: "tumblr_nmpd0alFSh1qa11wdo1_1280_nsofga.jpg"},
  { title: "Bus to Pacifica", body: "Share bus ride playlists with eachother. See you bright & early. Bring snacks.", location: "Bus Depot", date: DateTime.new(2016,2,19,7,0), group_id: groups[5].id, organizer_id: users[1].id, img_url: "tumblr_n1eus8sWdN1ts2owco1_1280_atfn7p.jpg"},
  { title: "Onwards to Seattle", body: "Let's road trip to Seattle! Bring good food, vibes, and music.", location: "SF->Seattle", date: DateTime.new(2016,2,17,8,0), group_id: groups[5].id, organizer_id: users[1].id, img_url: "21470549373_3e30a878f4_z_u7gxjs.jpg"},
  { title: "Show in the Tenderloin", body: "Get ready to dance and fill your ears with great acoustics.", location: "TL", date: DateTime.new(2016,2,24,20,0), group_id: groups[6].id, organizer_id: users[2].id, img_url: "tumblr_nii5qtOMlq1r6a3q3o1_1280_hb4fej.jpg"},
  { title: "Skyscrapers", body: "Stroll downtown and look up!", location: "FIDI", date: DateTime.new(2016,2,25,20,0), group_id: groups[7].id, organizer_id: users[2].id, img_url: "15554827613_8835f9f930_z_lb4cld.jpg"},
  { title: "Tagging", body: "Be the voice you want to hear", location: "Dogpatch", date: DateTime.new(2016,2,26,18,0), group_id: groups[0].id, organizer_id: users[10].id, img_url: "7698658660_57bdb7dc55_z_daops7.jpg"},
  { title: "Cats + Ice Cream", body: "Watch cats play whilst eating ice cream. Yum!", location: "Cat Cafe", date: DateTime.new(2016,2,24,18,0), group_id: groups[8].id, organizer_id: users.last.id, img_url: "8558214796_07be06f26f_z_ds0qwb.jpg" },
  { title: "Tomatina", body: "Theme = Tomatoes", date: DateTime.new(2016,2,20,18,0), location: "Susan's Kitchen", group_id: groups[9].id, organizer_id: users.last.id, img_url: "15230320080_1af27a20a9_z_jbed5m.jpg" },
  { title: "Spice it up!", body: "Try adding spices to your favorite treats. Yum!", group_id: groups[10].id, date: DateTime.new(2016,2,20,17,0), location: "Suzie's Kitchen", organizer_id: users.last.id, img_url: "16289464513_a61744a4d7_z_kxxtlp.jpg" },
  { title: "Island Hopping", body: "Hops, hopping, pack light.", group_id: groups[11].id, date: DateTime.new(2016,2,24,16,0), location: "Hawaii", organizer_id: users.last.id, img_url: "11635156324_febf69ff9a_z_cgnmmi.jpg" },
  { title: "Point and Shoot", body: "Just got a new lens to play with.", group_id: groups[12].id, date: DateTime.new(2016,2,28,15,0), location: "Rose Garden", organizer_id: users.last.id, img_url: "22880575061_a43a9b1cd1_z_qanq4l.jpg" },
  { title: "Windward", body: "Got a new RPG to test out", group_id: groups[13].id, date: DateTime.new(2016,2,26,14,0), location: "Kevin's Casa", organizer_id: users.last.id, img_url: "6925872019_6f97ebdd72_z_rge91p.jpg" },
  { title: "P&S", body: "Find your muse.", group_id: groups[14].id, date: DateTime.new(2016,2,29,13,0), location: "Dolores Park", organizer_id: users.last.id, img_url: "22948847511_7f83d44d89_z_b9wsgb.jpg" },
  { title: "Beach & Chill", body: "Get some sand b/w the toes, and in your shoes, always.", group_id: groups[15].id, date: DateTime.new(2016,2,29,12,0), location: "Bolinas", organizer_id: users.last.id, img_url: "18016138414_12eaa87ee9_z_wzylr0.jpg" },
  { title: "Six Barrel", body: "New cafe in town, must try the espresso shots", group_id: groups[16].id, date: DateTime.new(2016,2,27,18,0), location: "Kevin's Casa", organizer_id: users.last.id, img_url: "15174519466_271fd8d8b0_z_fcb0pb.jpg" },
  { title: "Snakes", body: "Enough said.", group_id: groups[17].id, date: DateTime.new(2016,2,29,3,0), location: "SF Zoo", organizer_id: users.last.id, img_url: "8584791307_13a992e9e8_z_hzpfn9.jpg" },
