      ...
      <div className="row">
        <div className="show-event-block">
          <div className='event-buttons'>
            <button className="glyphicon glyphicon-th" title="Back to Event" onClick={this._goBack}></button>
            <button className="glyphicon glyphicon-pencil" title="Edit Event" onClick={this._editEvent}></button>
            <button className="glyphicon glyphicon-trash" title="Delete Event" onClick={this._deleteEvent}></button>
          </div>
